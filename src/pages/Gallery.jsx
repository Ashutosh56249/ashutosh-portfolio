...
const IMAGES = {
  personal: [
    {
      id: 1,
      caption: "Riding through the whispers of the wind 🌬️🏍️",
      photos: ["/gallery/ride1.jpg", "/gallery/ride2.jpg"],
    },
    {
      id: 2,
      caption:
        "Just a random moment that felt right ✨",
      photos: ["/gallery/ph1.jpeg", "/gallery/ph2.jpeg"],
    },
  ],
  projects: [
    {
      id: 1,
      caption:
        "Analyzing emotions, promoting awareness, and prioritizing mental well-being 🌿",
      photos: ["/gallery/pro1.png", "/gallery/pro2.png"],
    },
  ],
  achievements: [
    {
      id: 1,
      caption: "Solved 260+ LeetCode questions 🏆!",
